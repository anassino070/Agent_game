...
const WORD_BANK := [
	"CONTRACT", "CLAUSULE", "BUDGET", "TRANSFER", "SPONSOR", "RESERVE", "SCOUTING", "SEIZOEN",
	"TALENT", "PRESTATIE", "SELECTIE", "FORMATIE", "TACTIEK", "OFFERTE", "PREMIE", "SALARIS",
	"AANVAL", "MIDVELD", "KEEPER", "SPITS", "COACH", "ASSISTENT", "NETWERK", "REPUTATIE",
	"SCHANDAAL", "GUNST", "KANTOOR", "RIVAAL", "AANBOD", "BIEDING", "WAARDE", "MARKT",
	"STADION", "SUPPORTER", "DOSSIER", "SCHIKKING", "BOETE", "SANCTIE", "LICENTIE", "COMMISSIE",
	"MAKELAAR", "PROVISIE", "IMAGO", "BONUS",
]
