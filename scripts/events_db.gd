...
static func get_events() -> Array:
	return [
		...
		},
		{
			...
			"options": [
				{"label": "Direct melden bij de bond", "effects": {"rep": 8, "scandal": 6, "trust": -6},
					"txt": "Netjes gehandeld — goed voor je naam bij de bond. Maar het wordt een openbaar dossier: er komt media op af, en hij voelt zich blootgesteld i.p.v. beschermd."},
				{"label": "Zelf regelen, geen ruchtbaarheid", "chance": 0.5,
					"success": {"trust": 14, "favors": 1},
					"success_txt": "Het kartel trekt zich stilletjes terug — via een contact dat voortaan bij je in het krijt staat. Hij is je enorm dankbaar dat het binnenskamers bleef.",
					"fail": {"scandal": 16, "trust": -10},
					"fail_txt": "Het kartel dreigt door. Het verhaal lekt alsnog uit — groter dan wanneer je het meteen had gemeld, en zonder de bond in je rug."},
			],
		},
		{
