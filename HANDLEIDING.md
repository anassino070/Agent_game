...
2. **Stalbeheer** — heb je 2 of meer cliënten, dan móét je er één wegsturen (de rest van je stal verliest er 2 vertrouwen door). Zo blijft er altijd ruimte — en reden — om te scouten. Per cliënt zie je hier rating, **potentieel** (exact bekend zodra iemand in je stal zit), vertrouwen en waarde, zodat je een geïnformeerde keuze maakt wie je laat gaan.
